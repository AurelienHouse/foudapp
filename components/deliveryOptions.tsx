...
const DeliveryOptions = ({ restaurantById }) => {
  ...
  return (
    <>
      <Text className=" mb-4 text-lg font-bold">Delivery or pickup ?</Text>
      {/* {1 row} */}
      <View className="flex flex-row items-center justify-between">
        <View className="flex flex-row items-center">
          ...
          <View className=" ml-2">
            ...
            <Text className=" text-sm text-gray-600">{restaurantById.delivery} min</Text>
          </View>
        </View>
        ...
        <View className="flex flex-row items-center">
          ...
          <TouchableOpacity
            ...
            onPress={() => handleOptionSelected('delivery')}
          />
        </View>
      </View>
      ...
      <View className="flex flex-row items-center justify-between">
        ...
        <View className="flex flex-row items-center">
          ...
          <TouchableOpacity
            ...
            onPress={() => handleOptionSelected('pickup')}
          />
        </View>
      </View>
      ...
      <View className="flex flex-row items-center justify-between">
        <View className="flex flex-row items-center">
          ...
          <View className=" ml-2">
            <Text className=" text-sm">Delivery</Text>
            <Text className=" text-sm text-gray-600">Select time</Text>
          </View>
        </View>
        ...
        <View className="flex flex-row items-center">
          ...
          <TouchableOpacity
            ...
            onPress={() => handleOptionSelected('schedule')}
          />
        </View>
      </View>
    </>
